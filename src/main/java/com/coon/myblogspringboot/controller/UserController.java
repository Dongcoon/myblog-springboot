...
import com.coon.myblogspringboot.model.KakaoProfile;
import com.coon.myblogspringboot.model.OAuthToken;
...
public class UserController {
    ...
    public String kakaoCallback(String code){
        ...
        params.add("client_id","e77e0d3ebe33f1e6e614b26522914129");
        ...
        System.out.println("블로그서버 유저네임: "+kakaoProfile.getProperties().getNickname()+"_"+kakaoProfile.getId());
